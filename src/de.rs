...
impl ParserNumber {
    ...
    fn invalid_type(self, exp: &dyn Expected) -> Error {
        match self {
            ...
            ParserNumber::U64(x) => de::Error::invalid_type(Unexpected::Unsigned(serde::as_unsigned_int!(x)), exp),
            ParserNumber::I64(x) => de::Error::invalid_type(Unexpected::Signed(serde::as_signed_int!(x)), exp),
            #[cfg(feature = "arbitrary_precision")]
